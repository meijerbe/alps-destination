...
| `specs/trailrun.spec.js` | de finishtijd-schatter — schatting en venster, aangepaste routes, onderlinge kansen, de geplakte uitslag (delen, alleen tijden bewaren, per wedstrijd apart), opslag en de bovenbalk op een telefoon |
